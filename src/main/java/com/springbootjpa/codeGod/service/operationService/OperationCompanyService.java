...
public interface OperationCompanyService {
     ...
     * @return
     */
    OperationCompanyEntity addCompany(String companyName, String companyAddress, String teamPhone, String accountName, String bank, String accountNumber, Integer companyDisplay);
     ...
     * @return
     */
    OperationCompanyEntity updateCompany(Long id, String companyName, String companyAddress, String teamPhone, String accountName, String bank, String accountNumber, Integer companyDisplay);
