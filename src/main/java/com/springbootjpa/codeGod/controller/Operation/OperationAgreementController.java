...
public class OperationAgreementController extends OperationBase {
    ...
    public AjaxResult<Object> setAgreement(String userServiceAgreement, String residentNotice, MultipartFile codeGodSignAgreement,
            MultipartFile workerOutsourcingAgreement, MultipartFile projectSignAgreement, MultipartFile parttimeAgreement,
            MultipartFile fulltimeAgreement, Integer recommendReward
    ){
        log.info("URL:/agreement/setAgreement 请求参数：用户服务协议："+ userServiceAgreement +"，驻场须知："+ residentNotice
                +"，推荐奖励："+ recommendReward);
