      ...
      <div v-if="step == 2" class="vicp-step2">
        <div class="vicp-crop">
          <div v-show="true" class="vicp-crop-left">
            <div class="vicp-img-container" v-show="false">
            ...
            <div class="vicp-range" v-show="false">
            ...
            <div v-if="!noRotate" class="vicp-rotate" v-show="false">
          ...
          <div v-show="true" class="vicp-crop-right">
            <div class="vicp-preview">
              <div v-if="!noSquare" class="vicp-preview-item">
                <img :src="createImgUrl" style="width: 150px; height: 150px;">
...
<script>
  ...
  export default {
    ...
    data () {
      ...
      const lang = language[langType.default] ? language[langType.default] : language['zh']
    ...
    methods: {
      ...
      prepareUpload (e) {
        ...
        formData.append('file', dataURLtoFile(that.createImgUrl, that.mime))
        formData.append('org_id', 'fro-ui-developer')
        formData.append('file_type', 'png')
        formData.append('source_code', '00000')
        api.upLoadImgList({
          data: formData,
          success: function (res) {
            that.loading = 2
            var fmdata = { 'ids': res.data.data, 'invalid_type': 2 }
            api.queryImgByCode({
              data: { 'params': fmdata },
              success: function (res) {
                console.log(res)
                that.$emit('crop-upload-success', res.data.data[0])
              }
            })
          },
          error: function () {
      ...
      upload () {
        ...
        let that = this,
          ...
          fmData = new FormData()
        fmData.append('file', dataURLtoFile(createImgUrl, mime))
        // 添加其他参数
